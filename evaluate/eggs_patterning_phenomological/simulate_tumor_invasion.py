...
update_functions = read_functions_as_expressions("./evaluate/eggs_patterning_phenomological/original.txt")

with open('./evaluate/eggs_patterning_phenomological/time_series.txt', 'w') as file:
    for _ in range(30):
        state = []
        time_series = []
        unique_tuples = set()
