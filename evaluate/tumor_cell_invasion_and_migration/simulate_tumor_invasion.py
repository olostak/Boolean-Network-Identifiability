...
update_functions = read_functions_as_expressions("./evaluate/tumor_cell_invasion_and_migration/original.txt")

with open('./evaluate/tumor_cell_invasion_and_migration/time_series.txt', 'w') as file:
    for _ in range(100):
        state = []
        time_series = []
        unique_tuples = set()
